...
namespace CertifiqInmetroWebScrapping.Scrap
{
    public class PreCertificadoScraping
    {
        public void ProcessarDocumento()
        {
            ...
            {
                SalvarDocumentoProblematico(documento);
            }
        ...
        private void SalvarDocumentoProblematico(HtmlConvenioModel documento)
        {
            var t = new MyMongoDbContext().SalvarHtmlConvenioTBFixed(documento);
            t.Wait();
        }
